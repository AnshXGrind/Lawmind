"""
LawMind Backend — Hugging Face Spaces
...
async def lifespan(app: FastAPI):
    logger.info("[*] LawMind starting on Hugging Face...")
    await init_db()
    logger.info("[+] Ready!")
    yield
...
# CORS — accepts Vercel + Hugging Face URLs automatically
app.add_middleware(
    CORSMiddleware,
...
# Load routers — skip any that fail (optional/heavy features degrade gracefully)
_routers = [
